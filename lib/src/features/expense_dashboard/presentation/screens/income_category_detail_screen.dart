...
class _IncomeCategoryDetailScreenState extends State<IncomeCategoryDetailScreen> {
  ...
  // Calcular ingresos de la categoría en el período anterior
  ...
  bool get _esVariacionCategoriaPositiva {
    return _porcentajeVariacionCategoria > 0; // Para ingresos, aumento es bueno
  }
                ...
                child: Row(
                  children: [
                    Icon(
                      ...
                      size: 16,
                      color: _sortBy == 'fecha' ? Colors.green : null,
                    ),
                ...
                child: Row(
                  children: [
                    Icon(
                      Icons.attach_money,
                      size: 16,
                      color: _sortBy == 'monto' ? Colors.green : null,
                    ),
                    const SizedBox(width: 8),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'No se encontraron ingresos en ${widget.categoriaNombre}\npara el período ${_selectedPeriod.toLowerCase()}',
          ...
          child: ListTile(
            ...
            title: Text(
              transaccion.descripcion.isNotEmpty 
                  ...
                  : 'Ingreso en ${widget.categoriaNombre}',
              style: TextStyle(
                fontSize: 16,
